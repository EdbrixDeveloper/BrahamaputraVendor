...
public class CircleLayout extends ViewGroup {
    ...
    protected void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            TypedArray a = getContext().obtainStyledAttributes(attrs, com.brahamaputra.mahindra.brahamaputra.R.styleable.CircleLayout);

            speed = a.getInt(com.brahamaputra.mahindra.brahamaputra.R.styleable.CircleLayout_speed, speed);
            radius = a.getDimension(com.brahamaputra.mahindra.brahamaputra.R.styleable.CircleLayout_radius, radius);
            isRotating = a.getBoolean(com.brahamaputra.mahindra.brahamaputra.R.styleable.CircleLayout_isRotating, isRotating);

            // The angle where the first menu item will be drawn
            angle = a.getInt(com.brahamaputra.mahindra.brahamaputra.R.styleable.CircleLayout_firstChildPosition, (int) angle);
